...
java -jar target/conload-1.0.0.jar
```
...
|-----------------------------|--------------------------------------------|---------------------------------------|
| `conload-1.0.0-mac.jar`     | macOS (auto-detects Apple Silicon / Intel) | `java -jar conload-1.0.0-mac.jar`     |
| `conload-1.0.0-linux.jar`   | Linux (x86_64)                             | `java -jar conload-1.0.0-linux.jar`   |
| `conload-1.0.0-windows.jar` | Windows (x86_64)                           | `java -jar conload-1.0.0-windows.jar` |
...
|----------|-------------------------------|---------------------------------------------------|
| macOS    | `./build-mac.sh`              | `target/installer/conload-1.0.0.dmg`               |
| Linux    | `./build-linux.sh [deb\|rpm]` | `target/installer/conload_1.0.0_amd64.<type>`     |
| Windows  | `build-windows.bat`           | `target/installer/conload-1.0.0.exe`               |
