...
public final class SessionExportCoordinator {
    private final Stage stage; private final Supplier<OpencodeSessionService> services;
    ...
    public SessionExportCoordinator(Stage stage, Supplier<OpencodeSessionService> services, Supplier<Path> contexts, Supplier<String> folder) { this.stage=stage; this.services=services; this.contexts=contexts; this.folder=folder; }
    ...
    public void export(OpencodeSession selected) {
